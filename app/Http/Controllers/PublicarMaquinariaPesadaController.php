...
class PublicarMaquinariaPesadaController extends Controller
{
    /**
    ...
    public function vehiculo()
    {
        ...
        return \View::make('maquinariaPesada.formulario', compact('marcas','modelos','tipo_vehiculos','colores','respuesta','seguridad','sonido','exterior',
