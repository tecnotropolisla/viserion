...
class PublicarMaquinariaAgricolaController extends Controller
{
    /**
    ...
    public function vehiculo()
    {
        ...
        return \View::make('maquinariaAgricola.formulario', compact('marcas','modelos','tipo_vehiculos','colores','respuesta','seguridad','sonido','exterior',
