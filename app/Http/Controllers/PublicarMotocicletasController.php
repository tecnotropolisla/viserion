...
class PublicarMotocicletasController extends Controller
{
	...
	{
		$marcas = Consultas::querysValor('marcasTipos','559');
		$modelos = Consultas::querys('modelos');
		$tipo_vehiculos = Consultas::querysValor('tipo_vehiculos','motocicletas');   
		$colores = Consultas::querys('colores');
		$respuesta = Consultas::querys('respuesta');
       $seguridad = Consultas::querysValor('seguridad','motocicletas');
       $sonido = Consultas::querysValor('sonido','motocicletas');
       $accesorios_internos = Consultas::querysValor('accesorios_internos','motocicletas');
		...
		$cilindrada = Consultas::querysValor('cilindrada','motocicletas'); 
		 
		return \View::make('motocicletas.formulario', compact('marcas','modelos','tipo_vehiculos','colores','respuesta','seguridad','sonido',
			'accesorios_internos','direccion','estereo','transmision','tapizado','vidrios','traccion','combustible','paises',
