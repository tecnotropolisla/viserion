...
class PublicarTrailerController extends Controller
{
    /**
    ...
    public function vehiculo()
    {
        ...
        return \View::make('trailers.formulario', compact('marcas','modelos','tipo_vehiculos','colores','respuesta','seguridad','sonido','exterior',
