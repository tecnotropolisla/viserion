...
class Vehiculo extends Model
{
    ...
    //protected $fillable = ['name', 'email', 'password'];
      protected $fillable = ['lng_idpersona','lng_idtipo_vehiculo','str_placa','lng_idmodelo','str_cilindrada','int_cilindros','int_ano',
      		...
      		'str_precio_venta','str_moneda','lng_idpais','str_video','status_admin','status_user','lng_idbano','lng_idventana'];
