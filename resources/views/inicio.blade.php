                                ...
                                <ul class="owl-carousel carousel-fw" id="vehicle-slider" data-columns="4" data-autoplay="" data-pagination="yes" data-arrows="no" data-single-item="no" data-items-desktop="4" data-items-desktop-small="3" data-items-tablet="2" data-items-mobile="1">
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            <a href="vehicle-details.html" class="media-box"><img src="autostars/images/car1.jpg" alt=""></a>
                                            <div class="vehicle-block-content">
                                                ...
                                                <a href="results-list.html" title="View all Sedans" class="vehicle-body-type"><img src="autostars/images/body-types/sedan.png" width="30" alt=""></a>
                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            <a href="vehicle-details.html" class="media-box"><img src="autostars/images/car2.jpg" alt=""></a>
                                            <div class="vehicle-block-content">
                                                ...
                                                <a href="results-list.html" title="View all SUVs" class="vehicle-body-type"><img src="autostars/images/body-types/suv.png" width="30" alt=""></a>
                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            <a href="vehicle-details.html" class="media-box"><img src="autostars/images/car4.jpg" alt=""></a>
                                            <div class="vehicle-block-content">
                                                ...
                                                <a href="results-list.html" title="View all convertibles" class="vehicle-body-type"><img src="autostars/images/body-types/convertible.png" width="30" alt=""></a>
                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            <a href="vehicle-details.html" class="media-box"><img src="autostars/images/car3.jpg" alt=""></a>
                                            <div class="vehicle-block-content">
                                                <span class="label label-default vehicle-age">2014</span>
                                                ...
                                                <a href="results-list.html" title="View all coupes" class="vehicle-body-type"><img src="autostars/images/body-types/coupe.png" width="30" alt=""></a>
                                        ...
                                        <ul class="owl-carousel" id="news-slider" data-columns="2" data-autoplay="" data-pagination="yes" data-arrows="yes" data-single-item="no" data-items-desktop="2" data-items-desktop-small="1" data-items-tablet="2" data-items-mobile="1">
                                            <li class="item">
                                                <div class="post-block format-standard">
                                                    <a href="single-post.html" class="media-box post-image"><img src="autostars/images/post2.jpg" alt=""></a>
                                            ...
                                            <li class="item">
                                                <div class="post-block format-standard">
                                                    <a href="single-post.html" class="media-box post-image"><img src="autostars/images/post1.jpg" alt=""></a>
                                                    <div class="post-actions">
                                            ...
                                            <li class="item">
                                                <div class="post-block format-standard">
                                                    <a href="single-post.html" class="media-box post-image"><img src="autostars/images/post3.jpg" alt=""></a>
                                                    <div class="post-actions">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <div class="row">
                                <ul class="owl-carousel" id="make-carousel" data-columns="5" data-autoplay="6000" data-pagination="no" data-arrows="no" data-single-item="no" data-items-desktop="5" data-items-desktop-small="4" data-items-tablet="3" data-items-mobile="3">
                                    <li class="item"> <a href="results-grid.html"><img src="autostars/images/logo_mercedes.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="autostars/images/logo_vw.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="autostars/images/logo_mazda.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="autostars/images/logo_bmw.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="autostars/images/logo_ford.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="autostars/images/logo_toyota.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="autostars/images/logo_ferrari.png" alt=""></a></li>
                                    <li class="item"> <a href="results-grid.html"><img src="autostars/images/logo_nissan.png" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
