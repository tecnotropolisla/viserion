                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 listing-form-wrapper">
                        <ol class="breadcrumb">
                          ...
                          <li class="active"> <i class="fa fa-ship"></i> Embarcaciones</li>
                        </ol>
                        <!-- SIDEBAR -->
                    ...
                    <div class="col-md-8 col-sm-8">
				    	...
				    	{!! Form::open(['route' => 'publicarEmbarcacion', 'class' => 'listing-add-form','enctype'=>'multipart/form-data', 'id' => 'formularioVehiculo', 'onKeypress' => 'if(event.keyCode == 13) event.returnValue = false']) !!}
                            ...
                            <section class="listing-form-content">
                                ...
                                <div id="listing-add-form-one" class="tab-pane fade in active">
                                    ...
                                    <div class="tab-content col-md-12">
                                        ...
                                        @include('embarcaciones.camposGenericos')

                                        <div id="formularioAnexo">
                                        
	                                        <div id="ambulancias">
	                                        	@include('embarcaciones.ambulancias')
	                                        </div>
                                         
	                                        <div id="autobuses">
	                                        	@include('embarcaciones.autobuses')
	                                        </div>   
	                                                                             	                                        
	                                        <div id="camiones">
	                                        	@include('embarcaciones.camiones')
	                                        </div>
	                                        
	                                        <div id="carrosCamionetas">
	                                        	@include('embarcaciones.carrosCamionetas')
	                                        </div>

                                            <div id="carrosGolf">
                                                @include('embarcaciones.carrosGolf')
                                            </div>

                                            <div id="gruas">
                                                @include('embarcaciones.gruas')
                                            </div>

                                            <div id="kartings">
                                                @include('embarcaciones.kartings')
                                            </div>
                                ...
                                <div id="listing-add-form-two" class="tab-pane fade">
									...
									@include('embarcaciones.caracteristicas')
                                ...
                                <div id="listing-add-form-four" class="tab-pane fade">
									...
									@include('embarcaciones.publicar')
