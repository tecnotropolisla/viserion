                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 listing-form-wrapper">
                        <ol class="breadcrumb">
                          ...
                          <li class="active"> <i class="fa fa-plane"></i> Aeronaves</li>
                        </ol>
                        <!-- SIDEBAR -->
                    ...
                    <div class="col-md-8 col-sm-8">
				    	...
				    	{!! Form::open(['route' => 'publicarAeronave', 'class' => 'listing-add-form','enctype'=>'multipart/form-data', 'id' => 'formularioVehiculo', 'onKeypress' => 'if(event.keyCode == 13) event.returnValue = false']) !!}
                            ...
                            <section class="listing-form-content">
                                ...
                                <div id="listing-add-form-one" class="tab-pane fade in active">
                                    ...
                                    <div class="tab-content col-md-12">
                                        ...
                                        @include('aeronaves.camposGenericos')

                                        <div id="formularioAnexo">
                                        
	                                        <div id="ambulancias">
	                                        	@include('aeronaves.ambulancias')
	                                        </div>
                                         
	                                        <div id="autobuses">
	                                        	@include('aeronaves.autobuses')
	                                        </div>   
                                            ...
                                            <div id="gruas">
                                                @include('aeronaves.gruas')
                                            </div>

                                            <div id="kartings">
                                                @include('aeronaves.kartings')
                                            </div>
                                ...
                                <div id="listing-add-form-two" class="tab-pane fade">
									...
									@include('aeronaves.caracteristicas')
