                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 listing-form-wrapper">
                        <ol class="breadcrumb">
                          ...
                          <li class="active"> <i class="fa fa-truck"></i> Trailers</li>
                        </ol>
                        <!-- SIDEBAR -->
                    ...
                    <div class="col-md-8 col-sm-8">
				    	...
				    	{!! Form::open(['route' => 'publicarTrailer', 'class' => 'listing-add-form','enctype'=>'multipart/form-data', 'id' => 'formularioVehiculo', 'onKeypress' => 'if(event.keyCode == 13) event.returnValue = false']) !!}
                            ...
                            <section class="listing-form-content">
                                ...
                                <div id="listing-add-form-one" class="tab-pane fade in active">
                                    ...
                                    <div class="tab-content col-md-12">
                                        ...
                                        @include('trailers.camposGenericos')

                                        <div id="formularioAnexo">
                                        
	                                        <div id="ambulancias">
	                                        	@include('trailers.ambulancias')
	                                        </div>
                                         
	                                        <div id="autobuses">
	                                        	@include('trailers.autobuses')
	                                        </div>   
	                                                                             	                                        
	                                        <div id="camiones">
	                                        	@include('trailers.camiones')
	                                        </div>
	                                        
	                                        <div id="carrosCamionetas">
	                                        	@include('trailers.carrosCamionetas')
	                                        </div>

                                            <div id="carrosGolf">
                                                @include('trailers.carrosGolf')
                                            </div>

                                            <div id="gruas">
                                                @include('trailers.gruas')
                                            </div>

                                            <div id="kartings">
                                                @include('trailers.kartings')
                                            </div>
                                ...
                                <div id="listing-add-form-two" class="tab-pane fade">
									...
									@include('trailers.caracteristicas')
