                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 listing-form-wrapper">
                        <ol class="breadcrumb">
                          ...
                          <li class="active"> <i class="fa fa-truck"></i> Maquinaria-Agricola</li>
                        </ol>
                        <!-- SIDEBAR -->
                    ...
                    <div class="col-md-8 col-sm-8">
				    	...
				    	{!! Form::open(['route' => 'publicarMaquinariaAgricola', 'class' => 'listing-add-form','enctype'=>'multipart/form-data', 'id' => 'formularioVehiculo', 'onKeypress' => 'if(event.keyCode == 13) event.returnValue = false']) !!}
                            ...
                            <section class="listing-form-content">
                                ...
                                <div id="listing-add-form-one" class="tab-pane fade in active">
                                    ...
                                    <div class="tab-content col-md-12">
                                        ...
                                        @include('maquinariaAgricola.camposGenericos')

                                        <div id="formularioAnexo">
                                        
	                                        <div id="ambulancias">
	                                        	@include('maquinariaAgricola.ambulancias')
	                                        </div>
                                         
	                                        <div id="autobuses">
	                                        	@include('maquinariaAgricola.autobuses')
	                                        </div>   
                                            ...
                                            <div id="gruas">
                                                @include('maquinariaAgricola.gruas')
                                            </div>

                                            <div id="kartings">
                                                @include('maquinariaAgricola.kartings')
                                            </div>
                                ...
                                <div id="listing-add-form-two" class="tab-pane fade">
									...
									@include('maquinariaAgricola.caracteristicas')
                                ...
                                <div id="listing-add-form-three" class="tab-pane fade">
									...
									@include('maquinariaAgricola.fotos')
                                ...
                                <div id="listing-add-form-four" class="tab-pane fade">
									...
									@include('maquinariaAgricola.publicar')
