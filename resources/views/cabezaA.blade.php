                        ...
                        <form>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input id="postcode" name="postcode" type="text" class="form-control" value="pruebas">
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="button" class="btn btn-block btn-info btn-lg" value="Buscar" onclick="buscador()">
                                        </div>
                                    </div>
                                </div>
                            </div>
