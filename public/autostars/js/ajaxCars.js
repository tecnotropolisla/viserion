...
/////////////////////////////////////////////////////////////////////////////// 
    ...
    function ImagenesGaleria() {
        ...
        document.querySelector('#btnCrop-1').addEventListener('click', function(){ croppedImage('1'); })
        document.querySelector('#btnCrop-2').addEventListener('click', function(){ croppedImage('2'); })
